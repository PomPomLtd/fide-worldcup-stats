          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 mb-2">Round 6 in progress</p>
                <p className="text-sm text-blue-200">639 games • 202 matches • 59,980 moves analyzed</p>
              </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">Round of 128</p>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">Round of 64</p>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">Round of 32</p>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">Round of 16</p>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">Quarterfinals</p>
              <p className="text-sm text-gray-500 dark:text-gray-500">2 matches • 4 games</p>
              <div className="mt-4 text-blue-600 dark:text-blue-400 flex items-center gap-2 font-medium">
                View Stats →
              </div>
            </Link>
        ...
        <div className="max-w-4xl mx-auto mt-16 p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <div className="text-3xl font-bold text-green-600 dark:text-green-400">639</div>
